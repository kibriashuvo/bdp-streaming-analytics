...
In my implementaion of streaming analysis, I have already implemented the feature of storing the analytics results into **mysimbdp-coredms**. Here, I have used `elasticsearch` as **mysimbdp-coredms**. My design is highlighted with red border below. Here my **customerstreamapp** sends the results of the streaming analysis to **mysimbdp-coredms** using the API provided by **mysimbdp-daas**. As I am using a new technology as my **mysimbdp-coredms**, so I conot reusing my previous implementation 
![sink](images/3-1.png)
